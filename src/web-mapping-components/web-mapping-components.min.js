...
var _Array = /*#__PURE__*/function () {
  ...
  _createClass(_Array, null, [{
    key: "Find",
    value: function Find(array, delegate) {
    ...
    key: "Filter",
    value: function Filter(array, delegate) {
      if (!array) return null;
      var filtered = [];
    ...
    key: "FindIndex",
    value: function FindIndex(array, delegate) {
      if (!array) return null;
    ...
    key: "Has",
    value: function Has(array, delegate) {
    ...
    key: "ForEach",
    value: function ForEach(array, delegate) {
      for (var i = 0; i < array.length; i++) {
        delegate(array[i], i);
      }
    }
    ...
    key: "Map",
    value: function Map(array, delegate) {
      var arr = [];
    ...
    key: "Join",
    value: function Join(array, separator, delegate) {
      var s = [];
    ...
    key: "Sort",
    value: function Sort(array, delegate, desc) {
    ...
    key: "Convert",
    value: function Convert(array, delegate) {
      for (var i in array) {
    ...
    key: "Index",
    value: function Index(array, delegate) {
      var index = {};
    ...
    key: "UniqueConcat",
    value: function UniqueConcat(a, b) {
    ...
    value: function Clone(array) {
      ...
      for (var i = 0; i < array.length; i++) {
        if (this.isArray(array[i])) clone.push(this.Clone(array[i]));else clone.push(array[i]);
      }
...
export { _Array as Array, Bookmarks, Control, Core, Dom, Download, Evented, Factory, Fullscreen, Menu as Group, Legend, Map, MapsList, Menu$1 as Menu, Navigation, Net, Legend$1 as Opacity, Other, Popup, promise_min as Promise, Search, Templated, Toc, Tooltip, typeahead as Typeahead, Util };
